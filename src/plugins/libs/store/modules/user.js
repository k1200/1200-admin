import { formatterRouters, formatterButtons } from '../../utils/addRouter';
import { apiLogin, apiTriggerApp, apiLogout } from '../../api';

export default (website, router) => {
	const { storage: STORAGE, auth: AUTH, formatMenus, refreshToken } = website;
	return {
		namespaced: true,
		state() {
			return {
